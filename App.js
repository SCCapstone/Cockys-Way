...
export default function App() {
  return (
    <View style={styles.container}>
      ...
      <Text>Jacob was here! banana apples Raffi was lit baby beluga I have a branch I have a branch</Text>
      <Text>Isaac was here! Hi Isaac, Ryan was here! resolving conflict. FUSION!!! HAA!!!!</Text>
